...
class TestPackage:
    def test_write_meta(self):
        ...
        assert actual_xml_str == """<meta property="dcterms:modified">2011-01-01T12:00:00Z</meta>"""

    def test_parse_meta(self):
        xml_str = """<meta property="dcterms:modified">2011-01-01T12:00:00Z</meta>"""
    ...
    def test_write_identifier(self):
        ...
        assert actual_xml_str == """<identifier id="pub-id">urn:uuid:64593003-b09e-40e7-817a-4a67f0f0c7e2</identifier>"""

    def test_parse_identifier(self):
        xml_str = """<identifier id="pub-id">urn:uuid:64593003-b09e-40e7-817a-4a67f0f0c7e2</identifier>"""
    ...
    def test_write_title(self):
        ...
        assert actual_xml_str == """<title>My Book Title</title>"""

    def test_parse_title(self):
        xml_str = """<title>My Book Title</title>"""
    ...
    def test_write_language(self):
        ...
        assert actual_xml_str == """<language>en-US</language>"""

    def test_parse_language(self):
        xml_str = """<language>en-US</language>"""
    ...
    def test_write_link(self):
        ...
        assert actual_xml_str == """<link media-type="application/xhtml+xml" rel="item" href="link.html"/>"""

    def test_parse_link(self):
        xml_str = """<link href="link.html" rel="item" media-type="application/xhtml+xml"/>"""
    ...
    def test_write_metadata(self):
        ...
        assert actual_xml_str == """<metadata><identifier id="pub-id">id-val</identifier><title>title-val</title><language>lang-val</language><meta property="meta-prop">meta-val</meta></metadata>"""

    def test_parse_metadata(self):
        xml_str = """<metadata><identifier id="pub-id">id-val</identifier><title>title-val</title><language>lang-val</language><meta property="meta-prop">meta-val</meta></metadata>"""
    ...
    def test_write_item(self):
        ...
        assert actual_xml_str == """<item id="item-id" href="item.html" media-type="application/xhtml+xml"/>"""

    def test_parse_item(self):
        xml_str = """<item id="item-id" href="item.html" media-type="application/xhtml+xml"/>"""
    ...
    def test_write_manifest(self):
        ...
        assert actual_xml_str == """<manifest><item id="item1" href="item1.html" media-type="application/xhtml+xml"/><item id="item2" href="item2.html" media-type="application/xhtml+xml"/></manifest>"""

    def test_parse_manifest(self):
        xml_str = """<manifest><item id="item1" href="item1.html" media-type="application/xhtml+xml"/><item id="item2" href="item2.html" media-type="application/xhtml+xml"/></manifest>"""
    ...
    def test_write_itemref(self):
        ...
        assert actual_xml_str == """<itemref linear="yes" idref="item-id"/>"""

    def test_parse_itemref(self):
        xml_str = """<itemref idref="item-id" linear="yes"/>"""
    ...
    def test_write_spine(self):
        ...
        assert actual_xml_str == """<spine toc="ncx"><itemref idref="item1"/><itemref idref="item2"/></spine>"""

    def test_parse_spine(self):
        xml_str = """<spine toc="ncx"><itemref idref="item1"/><itemref idref="item2"/></spine>"""
    ...
    def test_write_collection(self):
        ...
        assert actual_xml_str == """<collection role="mo-assets"><link media-type="application/xhtml+xml" rel="item" href="item1.html"/><link media-type="application/xhtml+xml" rel="item" href="item2.html"/></collection>"""

    def test_parse_collection(self):
        xml_str = """<collection id="c1" role="mo-assets"><link href="item1.html" rel="item" media-type="application/xhtml+xml"/><link href="item2.html" rel="item" media-type="application/xhtml+xml"/></collection>"""
